...

{
  ...
  "version": 1,
  "securityGroups": [],
  "displayName": "Elevar Monitoring Snapchat Tag",
  "brand": {
    "id": "brand_dummy",
    "displayName": "",
  ...
  "description": "The Snapchat Tag adds monitoring to your Snapchat Tags. Attach SC tag information to your variable errors and notice critical errors immediately.\n\nThe tag is powered by Elevar Monitoring Variables.",
...
[
  ...
  },
  {
    ...
    "help": "This will be used as the first parameter of the \"snaptr\" function",
    "valueHint": "track"
  },
  {
    "type": "TEXT",
    ...
    "simpleValueType": true,
    "alwaysInSummary": true,
    "help": "This will be used as the second parameter of the \"snaptr\" function",
    "valueHint": "PURCHASE"
  },
  {
    "type": "PARAM_TABLE",
    ...
    "help": "(Optional) This will be converted to a JSON object and will be sent as the third parameter of the \"snaptr\" function."
  }
]
